...
if __name__ == "__main__":
    ...
    env = TradingEnv(stock_data=yf.Ticker("GME"), period="3y", initial_balance=1000, lookback_window_size=lookback_window_size, punish_coef=0.01)
    # agent.train(env, train_episodes=50, save_path="./experiments/")

    agent.load("./experiments/2023-12-22-20-50-10_model")
    agent.test(env, test_episodes=10)